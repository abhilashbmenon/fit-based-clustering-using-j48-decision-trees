		...
		for (int expTimes = 0; expTimes < 200; expTimes++){
			...
			if ( array1.equals(array1Backup) && array2.equals(array2Backup) && array3.equals(array3Backup)){
				...
				if (accuracy > maxCorrectPercentage){
					...
					maxFc2 = fc2;
					maxFc3 = fc3;
                                        arffFunctions.generateArff(array1, "docs/intel_arff_header_always.txt", "model1Final.arff");
                                        arffFunctions.generateArff(array2, "docs/intel_arff_header_always.txt", "model2Final.arff");
                                        arffFunctions.generateArff(array3, "docs/intel_arff_header_always.txt", "model3Final.arff");
